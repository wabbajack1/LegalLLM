...
def get_faiss(model_name: str = 'mistral') -> FAISS:
    ...
    """
    ollama_embeddings = OllamaEmbeddings(base_url="http://127.0.0.1:11434", model="mistral")
    ...
    print(f"Loading {len(documents)} documents into FAISS store. Can take some time.")
